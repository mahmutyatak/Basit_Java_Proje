...
public class Kitap {
    ...
    public Kitap(String kitapAdi, String yazarAdi, int yayinYili, int fiyat) {
    ...
    Map<Integer, List<Kitap>> kitapci = new TreeMap<>();
    ...
    private void liste() {
        ...
        Set<Map.Entry<Integer, List<Kitap>>> setMap = kitapci.entrySet();
    ...
    private void kitapEkle() {
        ...
        Kitap kitaplar=new Kitap(kitapadi1,yazaAdi1,yil,fiyat);
